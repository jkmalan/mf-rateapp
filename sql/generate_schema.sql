...
CREATE TABLE IF NOT EXISTS `bkt_ltv` (
    ...
    `ltv_min` NUMERIC(15,5),
    `ltv_max` NUMERIC(15,5),
    `display` VARCHAR(255),
    PRIMARY KEY (`id`)
);
...
CREATE TABLE IF NOT EXISTS `bkt_fico` (
    `id` INT AUTO_INCREMENT,
    `fico_min` NUMERIC(15,5),
    `fico_max` NUMERIC(15,5),
    `display` VARCHAR(255),
    PRIMARY KEY (`id`)
);
...
CREATE TABLE IF NOT EXISTS `bkt_dscr` (
    `id` INT AUTO_INCREMENT,
    `dscr_min` NUMERIC(15,5),
    `dscr_max` NUMERIC(15,5),
    `display` VARCHAR(255),
    PRIMARY KEY (`id`)
);
...
CREATE TABLE IF NOT EXISTS `bkt_reserve` (
    `id` INT AUTO_INCREMENT,
    `reserve_min` NUMERIC(15,5),
    `reserve_max` NUMERIC(15,5),
    `display` VARCHAR(255),
    PRIMARY KEY (`id`)
);
...
CREATE TABLE IF NOT EXISTS `bkt_balance` (
    `id` INT AUTO_INCREMENT,
    `balance_min` NUMERIC(15,5),
    `balance_max` NUMERIC(15,5),
    `display` VARCHAR(255),
    PRIMARY KEY (`id`)
);
